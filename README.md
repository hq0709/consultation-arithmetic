...
一句话结论：**会诊要成立需要两件事——房间里得有人是对的，而且你得能认出是谁。
语言模型面板只有一点点前者，几乎没有后者。**

已完成 180 个多智能体配置 / 63,499 个 episode，横跨 3 个能力档、3 个医疗 benchmark、
5 种架构、面板规模 N ∈ {1,3,5,7,9}。全部闭源臂的真实花费 **$39**。
